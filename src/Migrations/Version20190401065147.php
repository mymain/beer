 ...
 */
final class Version20190401065147 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE beer ADD country_id INT NOT NULL AFTER brewer_id, ADD type_id INT NOT NULL AFTER country_id, DROP type');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE beer ADD type VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP country_id, DROP type_id');
    }
}
